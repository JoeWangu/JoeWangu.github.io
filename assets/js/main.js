    ...
    $(function () {
        ...
        $(document).on('click', function (e) {
            if (!$(e.target).closest('.dropdown').length) {
                ...
                $('.dropdown svg').html(`<use href="#angle-down-icon"></use>`);
            }
        });
    })
// SIDENAV OPEN AND CLOSE
    $(function () {
        function mobilecheck() {
            ...
            })(navigator.userAgentData || window.opera);
            return check;
        }
        const clickevent = mobilecheck() ? 'touchstart' : 'click';

        const items = $('.side-nav');
        ...
        $('#burger-toggle').on(clickevent, function () {
            // e.stopPropagation();
            // e.preventDefault();
